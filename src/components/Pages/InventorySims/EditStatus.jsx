...
class EditStatus extends Component {
  ...
  updateSimStatus = async () => {
    ...
    const { data } = await this.props.client.mutate({
      ...
      variables: {
        id: parseInt(this.props.simId, 10),
        phoneNumber: this.props.phoneNumber,
        simNumber: this.props.simNumber,
        ownerLoginId: getLoginId(),
        monthlyCharges: parseInt(this.props.monthlyCharges, 10),
        status: parseInt(this.state.simStatus, 10),
        service_provider_id: parseInt(this.props.serviceProviderId, 10)
      },
...
export default withStyles(styles)(
  withApolloClient(withSharedSnackbar(EditStatus))
)
